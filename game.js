...
function startTimer() {
  ...
  const timerInterval = setInterval(function() {
    ...
    if (timerValue === 0) {
      ...
      // Add logic here for what happens when the timer reaches 0 (e.g., end game)
      alert('Time is up!'); // Example: Show an alert
    }
  }, 1000); // Repeat every 1 second (1000 milliseconds)
}

// Call startTimer() to begin the countdown when your game starts
startTimer();
